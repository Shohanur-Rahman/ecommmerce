                    ...
                    <div class="col-sm-12 col-xs-12">
                        <form method="post" action="{{route('save_tag')}}" enctype="multipart/form-data" data-parsley-validate>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Sort Description" name="name" required="required" data-parsley-error-message="Enter product short description">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="kendo_editor" rows="6" id="name" placeholder="Sort Description" name="name" required="required" data-parsley-error-message="Enter product short description"> </textarea>
                            </div>
