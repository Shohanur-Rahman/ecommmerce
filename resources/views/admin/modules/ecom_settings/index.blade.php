        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="d-inline" action="{{route('ecom-settings.update',$ecomSetting->id)}}" method="post"
                        ...
                        <table id="datatable-buttons"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="number" name="shipping_cost" required="required"
